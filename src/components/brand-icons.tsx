...
export function TelegramIcon({ className, style }: IconProps) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <path d="M21.94 4.18a1 1 0 0 0-1.05-.16L2.5 11.5a1 1 0 0 0 .03 1.86l4.59 1.49 1.74 5.43a1 1 0 0 0 1.66.4l2.43-2.23 4.62 3.39a1 1 0 0 0 1.58-.62l3-15.16a1 1 0 0 0-.21-.88zM9.97 14.55l-.55 4.06-1.27-3.98 8.84-6.71-7.02 6.63z" />
    </svg>
  );
}
